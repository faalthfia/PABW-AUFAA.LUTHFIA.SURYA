# PABW-D - AUFAA LUTHFIA SURYA - 25523197
Repo ini memuat pembelajaran mata kuliah Pengembangan Aplikasi Berbasis Web

## Pertemuan 3 - Halaman Profil Saya
Topik halaman saya: Musik yang saya suka

- Judul Halaman: Musik yang saya suka
- Deskripsi: Website ini berisi daftar lagu favorit saya beserta tahun rilis, penyanyi/band, album, dan genre.
- Tautan Navigasi: Daftar Lagu, Tambah Lagu, Tentang Saya
- Dua bagian utama: Daftar lagu favorit, tambah lagu favorit
- Kolom tabel: Judul lagu, Tahun rilis, Penyanyi/Band, Album, dan Genre
- Kolom form: Judul lagu, Tahun rilis, Penyanyi/Band, Album, dan Genre
- Gambar: Musik-1.webp

## Catatan Penggunaan AI
Menggunakan AI di beberapa bagian, seperti memasukkan gambar dan membuat label select pada bagian Genre.
